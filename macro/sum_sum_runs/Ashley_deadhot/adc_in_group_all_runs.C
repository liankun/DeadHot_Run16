...
void adc_in_group_all_runs(int group=0){
  ...
  ifstream bad_high_ashley("ashley_high_only.txt");
  ifstream bad_low_ashley("ashley_low_only.txt");
...
//        if(i==7111) cout<<itegral0<<endl;	
  ...
  TFile* ofile = new TFile("work_2016_09_21/deadhot_adc_row_all_runs_ashely_only.root","RECREATE");

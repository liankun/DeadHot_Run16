...
void compare_deadhot(){
  ...
  ifstream high_real_deadhot("high_bad_list_merge.txt");
  ifstream low_real_deadhot("low_bad_list_merge.txt");
...
//   ofstream only_low_deadhot("low_real_deadhot_add_discrete_final.txt");
//   for(std::set<int>::iterator it=low_deadhot_no_db.begin(); it!=low_deadhot_no_db.end(); ++it){
//    int ch= (*it);

...
void deadhot_adc_repass(){
  ifstream high_deadhot("high_deadhot_stat_repass.txt");
  ifstream low_deadhot("low_deadhot_stat_repass.txt");
...
//      cout<<it->first<<" "<<it->second<<endl;     
  ...
  TFile* ofile = new TFile("deadhot_adc_repass.root","RECREATE");
